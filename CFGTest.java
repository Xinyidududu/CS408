...
//    @Test
//    public void addEdge_TwoNewNode(){ //new function here
//        cfg.addEdge(1002, m_m, m, 1003, m_m, m);
//        CFG.Node n = new CFG.Node(1002, m_m, m);
//        CFG.Node nn = new CFG.Node(1003, m_m, m);
//
//        assertTrue(cfg.nodes.contains(n));
//        assertTrue(cfg.nodes.contains(nn));
//
...
//    @Test
//    public void deleteNode_loop() { //new test case here
//        // 创建几个节点
...
//
//        // 添加边
//        cfg.addEdge(n1.position, n1.method, n1.clazz, n2.position, n2.method, n2.clazz);  // n1 -> n2
//        cfg.addEdge(n1.position, n1.method, n1.clazz, n3.position, n3.method, n3.clazz);  // n1 -> n3
//        cfg.addEdge(n2.position, n2.method, n2.clazz, n3.position, n3.method, n3.clazz);  // n2 -> n3
//
//        // 确保边已经成功添加
//        Assume.assumeTrue(cfg.edges.get(n1).contains(n2));
//        Assume.assumeTrue(cfg.edges.get(n1).contains(n3));
//        Assume.assumeTrue(cfg.edges.get(n2).contains(n3));
//
//        // 删除节点 n3 并且确认所有相关的边已经被删除
